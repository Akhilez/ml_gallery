            ...
            t.exports = function (p, e, g) {
                ...
                return function f() {
                    return g.getCalendar(e).then(function (e) {
                        ...
                        if (m(".position-relative h2", r).remove(), r.querySelector(".float-left.text-gray").innerHTML = g.summary_text, r.querySelector("include-fragment")) setTimeout(f, 500); else {
                            if (!0 === g.responsive) {
