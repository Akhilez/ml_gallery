...
import ml_logo from "../../../../ml_next/public/media/ml_logo.png";
    ...
    return (
      <Navbar bg="transparent" variant="light">
        ...
        <Nav.Link href={urls.ml_gallery.url} className={"nav-link"}>
          <div>
            <Home fontSize={"small"} className={"navIcon"} /> HOME
          </div>
        </Nav.Link>
        <Nav.Link href={urls.profile.url} className={"nav-link"}>
          <div>
            <Person fontSize={"small"} className={"navIcon"} /> PROFILE
          </div>
        </Nav.Link>
        <Nav.Link
        ...
        >
          <div>
            <GitHub fontSize={"small"} className={"navIcon"} /> REPO
          </div>
        </Nav.Link>
        <this.metaTags />
      </Navbar>
