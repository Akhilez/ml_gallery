...
import ProjectPaginator from "../../../components/project_paginator";
import { projects } from "../../gallery/project";
import {
  CartesianGrid,
  Legend,
  Line,
...
export default class LearnLinePage extends React.Component {
  render() {
    const project = projects.categories[0].projects[0];
    return (
      <div>
        {/*<ProjectsNav activeKey={this.props.project.id} />*/}
        <Container>
          <MLAppBar />
          <BreadCrumb path={project.links.app} />
          <Centered>
            <h1>Learn A Line</h1>
            <p>
              Predict the m and c values of the straight line (y = mx + c)
              equation.
            </p>
  ...
  render() {
    return (
      <div>
        ...
        <p>
          Set "m" and "c" values and train the Neural Network to predict these
          values.
        </p>
