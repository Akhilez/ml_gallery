...
import {ProfileBadge, GithubCalendar, Social, ResumeButton, ProjectBox} from './profile_components';
        ...
        return (
            <div>
                ...
                <p className="para no_href_p">
                    ...
                    href={urls.ml_gallery.url}>akhil.ai/gallery</Link>. I also work on my own independent projects. I
            ...
            <div>
                ...
                <div className="row project_box" style={{marginBottom: -40, marginTop: -30}}>
                    <div className="col-md-3">
                        <Link href={urls.ml_gallery.url}><img src={mlg_img} className="project_image" alt={"MLGallery Logo"}
