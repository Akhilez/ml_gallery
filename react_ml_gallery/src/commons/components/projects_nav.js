                        ...
                        <Nav>
                            {
                                projects.projects.map((project, index) => {
                                    return (
                                        <Nav.Item eventKey={`${project.id}`} href={project.links.app} key={project.id}>
                                            <p style={{margin: -5, fontSize: 16, color: (this.props.activeKey === project.id)?"gray": "#a6a6a6"}}>{index + 1}. {project.title}</p>
                                        </Nav.Item>
                                    );
                                })
                            }
